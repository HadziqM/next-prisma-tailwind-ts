...
class Status extends React.Component<StatusProps, StatusState> {
  ...
  render() {
    return (
      <div className="flex w-60 h-s9 bg-black row-span-2 flex-col text-white p-1 gap-1">
        ...
        <div className="flex-col flex bg-gray-800 rounded-lg w-full h-full status">
          ...
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            ...
            <div
              ...
              style={this.styles(this.props.gsm)}
            ></div>
          </div>
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            <p>Signal Satelit</p>
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.satelite)}
            ></div>
          </div>
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            <p>Internet</p>
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.internet)}
            ></div>
          </div>
          ...
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            ...
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.flow)}
            ></div>
          </div>
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            <p>Level Sensor</p>
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.level)}
            ></div>
          </div>
          ...
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            ...
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.rpm)}
            ></div>
          </div>
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            ...
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.oil)}
            ></div>
          </div>
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            ...
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.vibration)}
            ></div>
          </div>
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            ...
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.temp)}
            ></div>
          </div>
          ...
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            ...
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.gps)}
            ></div>
          </div>
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            <p>Slant Sensor</p>
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.slant)}
            ></div>
          </div>
          <div className="flex items-center justify-between w-full pl-10 pr-16">
            <p>Camera</p>
            <div
              className="border rounded-full h-2 w-2"
              style={this.styles(this.props.camera)}
            ></div>
          </div>
        </div>
      </div>
